...
impl str::FromStr for Country {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        let res = match s {
            ...
            "ZM" => Country::ZM,
            "ZW" => Country::ZW,
            _ => Country::Unspecified,
        };
        if let Country::Unspecified = res {
            Err(CountryParseError::InvalidCountryCode(s.to_string()))
        } else {
            Ok(res)
        }
    }
...
impl Country {
    ...
    pub fn to_str(&self) -> &'static str {
        match self {
            ...
            Country::ZM => "ZM",
            Country::ZW => "ZW",
            _ => panic!("you use unspecified country code. get out here!"),
        }
    }
}
